  ...
  return (
    <div className="space-y-3">
      ...
      <div>
        ...
        <div className="mt-2 ml-1 sm:ml-2 overflow-x-auto">
          <div className="min-w-[500px] space-y-3 pb-2">
            {data.leaves.map((leave, index) => (
              <div
                ...
                className="
                  grid
                  grid-cols-[140px_70px_150px_70px]
                  sm:grid-cols-[200px_120px_180px_120px]
                  items-center
                  gap-4
                "
              >
      ...
      <div className="border-t pt-3">
        ...
        <div className="space-y-3 ml-0 sm:ml-2">
          <div className="grid grid-cols-1 lg:grid-cols-[280px_180px] items-center gap-1 sm:gap-4">
          ...
          {data.continuousLeave.enabled && (
            <>
              <div className="grid grid-cols-1 lg:grid-cols-[320px_180px] items-center gap-1 sm:gap-4">
                <label className="text-sm text-secondary">
      ...
      <div className="border-t pt-3">
        ...
        <div className="space-y-3 ml-0 sm:ml-2">
          ...
          {data.sandwichRule.enabled && (
            <>
              <div className="grid grid-cols-1 lg:grid-cols-[380px_180px] items-center gap-1 sm:gap-4">
                <label className="text-sm text-secondary">
